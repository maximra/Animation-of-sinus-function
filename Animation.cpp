...
void WindowGenerator::draw_wave_function_with_set_freq(const double& freq)   // Draws the sin wave function with set frequency
{
    sin_changed_freq a(array_size,freq);
    // Clear the color buffer
    glClear(GL_COLOR_BUFFER_BIT);
